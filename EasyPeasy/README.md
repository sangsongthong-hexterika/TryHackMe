...
![THM-EasyPeasy-4-gobuster-hidden](Images/THM-EasyPeasy-4-gobuster-hidden.png)

Then, I navigate to `/hidden/whatever` directory.

![THM-EasyPeasy-4-hidden-whatever](Images/THM-EasyPeasy-4-hidden-whatever.png)
...
![THM-EasyPeasy-5-hidden-whatever-sourceCode](Images/THM-EasyPeasy-5-hidden-whatever-sourceCode.png)

Then, I use `cyberchef` to decode it.

![THM-EasyPeasy-6](Images/THM-EasyPeasy-6.png)
...
![THM-EasyPeasy-7-gobuster-ip-port-1](Images/THM-EasyPeasy-7-gobuster-ip-port-1.png)

Then, I faced with ***User-agent** which can be cracked using `md5hash`.

![THM-EasyPeasy-robots-text-user-agent](Images/THM-EasyPeasy-robots-text-user-agent.png)

![THM-EasyPeasy-9-Flag2](Images/THM-EasyPeasy-9-Flag2.png)
...
![THM-EasyPeasy-10-Flag3](Images/THM-EasyPeasy-10-Flag3.png)
...
![Images/THM-EasyPeasy-8](Images/THM-EasyPeasy-8.png)

I cracked it using `CyberChef` again.

![THM-EasyPeasy-11-hidden-cyberChef](Images/THM-EasyPeasy-11-hidden-cyberChef.png)
...
![THM-EasyPeasy-12-john-cracked](Images/THM-EasyPeasy-12-john-cracked.png)
...
![THM-EasyPeasy-13-downloadThePic](Images/THM-EasyPeasy-13-downloadThePic.png)

From here, I performed stegnography to get the hash.
![THM-EasyPeasy-14-stegnograhyResult](Images/THM-EasyPeasy-14-stegnograhyResult.png)

![THM-EasyPeasy-15-ssh-user](Images/THM-EasyPeasy-15-ssh-user.png)
...
![THM-EasyPeasy-convertingBinary](Images/THM-EasyPeasy-convertingBinary.png)
...
![THM-EasyPeasy-16-ssh-login](Images/THM-EasyPeasy-16-ssh-login.png)
...
![THM-EasyPeasy-17-get-user-flag](Images/THM-EasyPeasy-17-get-user-flag.png)

I cracked it using ROT13.

![THM-EasyPeasy-23](Images/THM-EasyPeasy-23.png)
...
![THM-EasyPeasy-24](Images/THM-EasyPeasy-24.png)

![THM-EasyPeasy-25](Images/THM-EasyPeasy-25.png)
...
![THM-EasyPeasy-openAListeningPort](Images/THM-EasyPeasy-openAListeningPort.png)

![THM-EasyPeasy-editTheFileWithReverseShell](Images/THM-EasyPeasy-editTheFileWithReverseShell.png)
...
![THM-EasyPeasy-26](Images/THM-EasyPeasy-26.png)
...
![THM-EasyPeasy-27](Images/THM-EasyPeasy-27.png)
